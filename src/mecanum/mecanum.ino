...
{
                        /*kp    ki    kd   ctrl_freq*/
  pid[0] = new FastPID  (0.5, 0.2, 0.00006, 24 /*Hz*/, true);
  pid[1] = new FastPID  (0.5, 0.2, 0.00006, 24 /*Hz*/, true);
  pid[2] = new FastPID  (0.5, 0.2, 0.00006, 24 /*Hz*/, true);
  pid[3] = new FastPID  (0.5, 0.2, 0.00006, 24 /*Hz*/, true);
}
